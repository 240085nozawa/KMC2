...
public class PlayerController : MonoBehaviour
{
    ...
    private CubeFaceManager faceManager = new CubeFaceManager();
    ...
    void Start()
    {
        ...
        arrowManager = new ArrowManager(arrowPrefab, transform, tileLayer, faceManager);
    ...
    public void TryMove(Vector3 direction)
    {
        ...
        if (IsTilePresent(targetPos))
        {
            ...
            string cubeTexture = faceManager.GetFaceForDirection(direction).ToLower();
